  ...
  return (
    <div className="cdx-root">
      ...
      <div className="cdx-header">
        <p className="cdx-eyebrow">Panel Admin — Acara Baru</p>
        <h1 className="cdx-title">Tambah Event</h1>
        <p className="cdx-subtitle">Lengkapi detail event untuk menerbitkannya ke sistem.</p>
      </div>
